...
export default function Home(){
  ...
  <section className="about section-pad" id="about">
    <figure className="about-profile"><img src={`${basePath}/about/amit-kumar.jpg`} alt="Amit Kumar, Founder and Principal Consultant at Navoraa" width="181" height="181"/><figcaption><strong>Amit Kumar</strong><span>Founder · Principal Consultant</span></figcaption></figure>
